      ...
      --------------------------------------------------------    
            ...
            with tf.variable_scope('Mixed_5b'):  # 第一个Inception Module名称。Inception Module有四个分支
                ...
                with tf.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(
                        branch_1, 64, [5, 5], scope='Conv2d_0b_5x5')  # 35x35x64
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(
                        branch_2, 96, [3, 3], scope='Conv2d_0c_3x3')  # 35x35x96
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(
                        branch_3, 32, [1, 1], scope='Conv2d_0b_1x1')  # 35*35*32
...
----------------------------------------------------------------------    
        ...
        '''
            ...
            with tf.variable_scope('Mixed_6a'):
                ...
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(
                        net, 64, [1, 1], scope='Conv2d_0a_1x1')  # 35*35*64
                    branch_1 = slim.conv2d(
                        branch_1, 96, [3, 3], scope='Conv2d_0b_3x3')  # 35*35*96
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes],  # 定义参数默认值
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],  # 定义标志默认值
            ...
            net, end_points = inception_v3_base(
                inputs, scope=scope)  # 用定义好的函数构筑整个网络的卷积部分
            ...
            end_points['Predictions'] = prediction_fn(
                logits, scope='Predictions')  # Softmax对结果进行分类预测
